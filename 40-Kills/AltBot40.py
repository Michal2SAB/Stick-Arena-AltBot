# Since each server except labpass one had the 40 kill limit, there was no point dealing with bad TOR connections anymore. Instead we could spread the alting games across multiple servers, 4 in each.
# Altbot capable of making 880 kills per 5 min (1 SA round) and 253440 kills per day (24 hours)
    ...
    def connectionHandler(self):
        ...
        while hasattr(self, "SocketConn"):
            try:
                ...
                print('\a')
                print(self.Username + " - BUFFER EXCEPTION OCCURED")
                break
    ...
    def collect(self):
        ...
        while roomNr < 23: # 23
            ...
            if(roomNr == 4 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick7.xgenstudios.com', 1138, self.Username, True, 4)
                break
            elif(roomNr == 8 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick8.xgenstudios.com', 1138, self.Username, True, 8)
                break
            elif(roomNr == 12 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick9.xgenstudios.com', 1138, self.Username, True, 12)
                break
            elif(roomNr == 16 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick4.xgenstudios.com', 1138, self.Username, True, 16)
                break
            elif(roomNr == 20 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick1.xgenstudios.com', 80, self.Username, True, 20)
                break
            elif(roomNr == 0 and self.startedNow != True):
                AltNext(self.Username, self.Password, 'ballistick5.xgenstudios.com', 1138, self.Username, True, 0)
                break
        ...
        if(self.Username == self.mainUsername):
            ...
            while self.altVar:
                try:
                    ...
                    print("Error with config var") # delete try except if theres problems

class AltNext:
    def __init__(self, Username, Password, ServerIP, ServerPort, mainAlt = '', startedNow = True, startPt = 0):
        AltBot(Username, Password, ServerIP, ServerPort, mainAlt, startedNow, startPt)
...
class AltKing:
    def __init__(self):
        ...
        AltBot(self.deathAlt+"1", self.deathPW, 'ballistick5.xgenstudios.com', 1138) # 45.32.193.38
        time.sleep(sleepTime) # potential for 24 games - 13,2916666667 (14,5 x 22 = 319)
        AltBot(self.deathAlt+"2", self.deathPW, 'ballistick5.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"3", self.deathPW, 'ballistick5.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"4", self.deathPW, 'ballistick5.xgenstudios.com', 1138)
        time.sleep(sleepTime)


        AltBot(self.deathAlt+"5", self.deathPW, 'ballistick7.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"6", self.deathPW, 'ballistick7.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"7", self.deathPW, 'ballistick7.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"8", self.deathPW, 'ballistick7.xgenstudios.com', 1138)


        time.sleep(sleepTime)
        AltBot(self.deathAlt+"9", self.deathPW, 'ballistick8.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"10", self.deathPW, 'ballistick8.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"11", self.deathPW, 'ballistick8.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"12", self.deathPW, 'ballistick8.xgenstudios.com', 1138)


        time.sleep(sleepTime)
        AltBot(self.deathAlt+"13", self.deathPW, 'ballistick9.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"14", self.deathPW, 'ballistick9.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"15", self.deathPW, 'ballistick9.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"16", self.deathPW, 'ballistick9.xgenstudios.com', 1138)
    
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"17", self.deathPW, 'ballistick4.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"18", self.deathPW, 'ballistick4.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"19", self.deathPW, 'ballistick4.xgenstudios.com', 1138)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"20", self.deathPW, 'ballistick4.xgenstudios.com', 1138)


        time.sleep(sleepTime)
        AltBot(self.deathAlt+"21", self.deathPW, 'ballistick1.xgenstudios.com', 80)
        time.sleep(sleepTime)
        AltBot(self.deathAlt+"22", self.deathPW, 'ballistick1.xgenstudios.com', 80)
        
        AltBot(self.mainAccount, self.mainPW, 'ballistick5.xgenstudios.com', 1138, self.mainAccount)
